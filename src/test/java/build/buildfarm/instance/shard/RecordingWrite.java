...
/** Minimal Write fake recording cancel invocations and their payloads. */
final class RecordingWrite implements Write {
  final SettableFuture<Long> future = SettableFuture.create();
  final AtomicInteger cancelCount = new AtomicInteger();
  String lastCancelMessage;
  Throwable lastCancelCause;
